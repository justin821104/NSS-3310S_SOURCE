...
namespace NeptuneC_Interface
{
    ...
    public struct NEPTUNE_XML_NODE_LIST
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = (128 * 256))]
    ...
    {
        public UInt32 nCount;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = (64 * 256))]
        public String pstrList;
    ...
    //////////////////////////////////////////////////////////////////////////
    public class NeptuneC
    {
        const String strFileName = "NeptuneC_MD_VC100.dll";
