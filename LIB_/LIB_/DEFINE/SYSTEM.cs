namespace NSS_3310S
{
    ...
    public class CP
    {
        ...
        public const int UseABF                         = 165;  // 설비 MES 자재명으로 바코드 비교 사용 유무 (T:사용, F:미사용)
        public const int MapBlockErrorMoveing           = 166;  // 맵블록 유닛 존재 할 경우 배출 속도 (mm/sec)
        public const int UnitPkrPicCheckDelay           = 167;  // 언로더 피커 다이싱 테이블 픽업 진행 확인 대기 시간 (msec)
        public const int UseLogBarcodeHistory           = 168;  // 바코드 이력 확인 로그 저장 사용 유무 (맵블록에서 바코드 정보 사라짐으로 확인)
        public const int ITSLength                      = 169;  // ITS 자리수 인터락 (0이면 스킵)
        public const int UseSizeNGRejectBox             = 170;  // 사이즈 불량 유닛 reject box로 배출 사용 유무 

        public const int SmartLoction_Dir               = 171;  // 스마트 좌표계 스트립 피커 옵셋 피치 부호 반전 유무

        public const int DBReadMode                     = 172;  // ITS DB READ 모드 (0:기존 모드 , 1: 옵션 테스트1, 2: 옵션 테스트2) 

        public const int PRSStepSpeed                   = 173;  // PRS 스탭 속도
        public const int PRSStepSpeedHalf               = 174;  // PRS 스탭 2번째 검사부터 속도 절반으로 진행

        public const int UseNGBoxError                  = 175;  // NG 유닛 박스 FULL 감지 센서 사용 유무 
        public const int UsePRSOffset                   = 176;  // PRS 검사 OFFSET XY값 적용 유무
        public const int UsePRSOffsetT                  = 177;  // PRS 검사 OFFSET T값 적용 유무

        public const int PrsStapInspectionDelay         = 178;  // PRS 스탭모드시 검사 전 대기 시간.
        #region >> ARRAY
        public static int[] UseData = { LogSaveSkip, UseBz, UseAREA,
                                                    ...
                                                    UnitPkPlcBrush, UseLogBarcodeHistory, UseSizeNGRejectBox, UseNGBoxError };
        public static int[] UseData1 = {    UseMgzCheck1, UseMgzCheck2, UseITSData,
                                            UesBtmInspection, UseBtmInspectionResult, UseMsSQL, UseBarcode, UseMES, UseRFID, UseABF, UsePRSOffset, UsePRSOffsetT
        };
        ...
        public static int[] MTPara = new int[] {  ElvUpDownPitch, ElvULDUpDownPitch, GripperBackPitch, RailOpenPitch,
                                                  ...
                                                  StageHeightPitch, MapBlockErrorMoveing,
    ...
    public class RP
    {
        ...
        public const int PCB_TYPE                   = 31;   // PCB 타입 (2:B1 QUAD / 1:QUAD / 0:STRIP)
        ...
        //PRS 검사 Z축 위치 옵셋
        public const int HD1_Z1_PRSOffset           = 40;
        public const int HD1_Z2_PRSOffset           = 41;
        public const int HD1_Z3_PRSOffset           = 42;
        public const int HD1_Z4_PRSOffset           = 43;
        public const int HD1_Z5_PRSOffset           = 44;
        public const int HD1_Z6_PRSOffset           = 45;

        public const int HD2_Z1_PRSOffset           = 50;
        public const int HD2_Z2_PRSOffset           = 51;
        public const int HD2_Z3_PRSOffset           = 52;
        public const int HD2_Z4_PRSOffset           = 53;
        public const int HD2_Z5_PRSOffset           = 54;
        public const int HD2_Z6_PRSOffset           = 55;
        ...
        public static int[] HD1_PRS_OFFSET = { HD1_Z1_PRSOffset, HD1_Z2_PRSOffset, HD1_Z3_PRSOffset, HD1_Z4_PRSOffset, HD1_Z5_PRSOffset, HD1_Z6_PRSOffset };
        public static int[] HD2_PRS_OFFSET = { HD2_Z1_PRSOffset, HD2_Z2_PRSOffset, HD2_Z3_PRSOffset, HD2_Z4_PRSOffset, HD2_Z5_PRSOffset, HD2_Z6_PRSOffset };
