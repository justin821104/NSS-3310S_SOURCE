    ...
    public class GOOD_TRAY_FEEDER_1 : BASE{
        ...
        public void DoAuto(){
            ...
            StackerMode:
                ...
                while (B.WaitBIT(nThread, B.GoodTray2Loading, true, "GOOD FEEDER2 트레이 공급 중 대기")) ;
                GetEmptyTray(nThread, eTRAY.GOOD1, "GOOD FEEDER1 트레이 공급");

                while (B.WaitBIT(nThread, B.GoodTray2Place, true, "GOOD TRAY2 유닛 플레이스 작업 진행 중 대기")) ;
                ...
                if (prMACHINE[CP.TrayUnloadingMode] == (int)eULD_TRAY.CONVEYOR){
                    while (B.WaitBIT(nThread, B.GoodTray2ULDEnd, true, "GOOD TRAY2 콘베어 배출 완료 때까지 대기")) ;
                }
