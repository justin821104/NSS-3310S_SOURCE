...
namespace NSS_3310S.SEQ.MODULE{
    public class GOOD_TRAY_FEEDER_2 : BASE{
        readonly int nThread = T.GoodTrayFeeder2;
        ...
        public void DoAuto(){
            ...
            StackerMode:
                ...
                while (B.WaitBIT(nThread, B.GoodTray1Loading, true, "GOOD FEEDER1 트레이 공급 중 대기")) ;
                GetEmptyTray(nThread, eTRAY.GOOD2, "GOOD FEEDER2 트레이 공급");

                while (B.WaitBIT(nThread, B.GoodTray1Place, true, "GOOD TRAY1 유닛 플레이스 작업 진행 중 대기")) ;
                ...
                if (prMACHINE[CP.TrayUnloadingMode] == (int)eULD_TRAY.CONVEYOR){
                    while (B.WaitBIT(nThread, B.GoodTray1ULDEnd, true, "GOOD TRAY1 콘베어 배출 완료 때까지 대기")) ;
                }
