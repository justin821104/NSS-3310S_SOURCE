        ...
        public void DoAuto(){
            ...
            do{
                ...
                if (eMCStatus != eMachineStatus.AUTO ||
                    ...
                    (prMACHINE[CP.TrayUnloadingMode] == (int)eULD_TRAY.CONVEYOR && prMACHINE[CP.SelectConveyorUnloading] == (int)eGOOD_TRAY.GD1)) continue;
                ...
                TrayUnitPlace(nThread, eTRAY.GOOD2, "GOOD TRAY2 유닛 플레이스 작업");
